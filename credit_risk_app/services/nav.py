...
are built. Each item also carries a `section`: "main" is the 11-slide live
...
NAV_ITEMS = [
    ...
    # is the whole live talk, start to finish.
    ...
    dict(order=6, title="Lift & Gains", endpoint="model_lift.index", built=True, section="main"),
    dict(order=7, title="What-If Simulator", endpoint="simulator.index", built=True, section="main"),
    dict(order=8, title="Portfolio Scenario Simulator", endpoint="scenario.index", built=True, section="main"),
    dict(order=9, title="Collection Queue", endpoint="collection.index", built=True, section="main"),
    dict(order=10, title="Cost-Benefit Analyzer", endpoint="costbenefit.index", built=True, section="main"),
    dict(order=11, title="Final Recommendation", endpoint="recommendation.index", built=True, section="main"),
    ...
    dict(order=12, title="Business Problem", endpoint="journey.business_problem", built=True, section="appendix"),
    dict(order=13, title="Credit Risk Journey", endpoint="journey.index", built=True, section="appendix"),
    dict(order=14, title="Variable Explorer", endpoint="variables.index", built=True, section="appendix"),
    dict(order=15, title="Exploratory Data Analysis", endpoint="eda.index", built=True, section="appendix"),
    dict(order=16, title="Feature Engineering", endpoint="features.index", built=True, section="appendix"),
    dict(order=17, title="Leakage & Governance", endpoint="governance.index", built=True, section="appendix"),
    dict(order=18, title="Baseline Model", endpoint="model_baseline.index", built=True, section="appendix"),
    dict(order=19, title="Advanced Models", endpoint="model_advanced.index", built=True, section="appendix"),
    dict(order=20, title="ROC / AUC", endpoint="model_roc.index", built=True, section="appendix"),
    dict(order=21, title="KS Analysis", endpoint="model_ks.index", built=True, section="appendix"),
